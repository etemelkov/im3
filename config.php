...
$host     = 'os1a9a.myd.infomaniak.com';     // Hostserver, auf dem die DB läuft.
// «localhost» bedeutet: die selbe Serveradresse, auf dem auch die Seiten gespeichert sind

$dbname   = 'os1a9a_IM3_Datenbank_ElenaTemelkov';   // Name der Datenbank
$username = 'os1a9a_Elena';   // Benutzername für die DB
$password = 'EleJana2002!!';   // Passwort für die DB
